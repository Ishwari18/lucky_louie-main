...
const stakingcontractAddress = "0x4ddd7b7adC3Cd1A16b7b2c5a8EB0E6A20B52Bb39";
const tokenContractAddress = "0x1e181E387786D7a3d18520fE335aCDF97C3519d8";
...
export default function Stake() {
  ...
  const approve = async (amount) => {
	try {
	  ...
	  const allowance = await tokenContract.allowance(signer.getAddress(), stakingcontractAddress);
  ...
  return (
    ...
    >
      ...
      <div className={styles.pills}>
        ...
        />
        <button
          className={styles.pill + " bg-[#000000] font-bold"}
          onClick={handleStake}
        >
          Stake
        </button>
